                ...
                for (int i = 0; i < Reader.Hazards.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetHazardItem.Name.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Npcs.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetNpcItem.Name.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetShortName.Length > 0)
                        {
                            ...
                            BindingKey(GetNpcItem.ShortName.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Worldspaces.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetWorldspaceItem.Name.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Shouts.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetShoutItem.Name.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Trees.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetTreeItem.Name.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Ingestibles.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetIngestibleItem.Name.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Races.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetRaceItem.Name.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetDescription.Length > 0)
                        {
                            ...
                            BindingKey(GetRaceItem.Description.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Quests.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetQuestItem.Name.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetDescription.Length > 0)
                        {
                            ...
                            BindingKey(GetQuestItem.Description.StringsKey, GetUniqueKey);
                        }
                                ...
                                for (int ir = 0; ir < GetQuestItem.Objectives.Count; ir++)
                                {
                                    try
                                    {
                                        ...
                                        if (GetDisplayText.Length > 0)
                                        {
                                            ...
                                            BindingKey(GetObjectiveItem.DisplayText.StringsKey, GetUniqueKey);
                                        }
                                    }
                                    catch (Exception ex)
                                    {
                                        ...
                                        for (int iii = 0; iii < GetQuestItem.Stages[ii].LogEntries.Count; iii++)
                                        {
                                            try
                                            {
                                                ...
                                                if (GetEntry.Length > 0)
                                                {
                                                    ...
                                                    BindingKey(GetLogEntrieItem.Entry.StringsKey, GetUniqueKey);
                                                }
                                            }
                                            catch (Exception ex)
                                            {
                ...
                for (int i = 0; i < Reader.Factions.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetFactionItem.Name.StringsKey, GetUniqueKey);
                        }
                                        ...
                                        try
                                        {
                                            ...
                                            if (GetRank.Title != null)
                                            {
                                                ...
                                                if (GetFemale.Trim().Length > 0)
                                                {
                                                    ...
                                                    BindingKey(GetRank.Title.Female.StringsKey, GetUniqueKey);
                                                }
                                                if (GetMale.Trim().Length > 0)
                                                {
                                                    ...
                                                    BindingKey(GetRank.Title.Male.StringsKey, GetUniqueKey);
                                                }
                                            }
                                        }
                                        catch (Exception ex)
                ...
                for (int i = 0; i < Reader.Perks.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetPerkItem.Name.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetDescription.Length > 0)
                        {
                            ...
                            BindingKey(GetPerkItem.Description.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Weapons.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetWeapon.Name.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetDescription.Length > 0)
                        {
                            ...
                            BindingKey(GetWeapon.Description.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.SoulGems.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetSoulGem.Name.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Armors.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetArmor.Name.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetDescription.Length > 0)
                        {
                            ...
                            BindingKey(GetArmor.Description.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Keys.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetKey.Name.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Containers.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetContainer.Name.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Activators.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetActivator.Name.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetActivateTextOverride.Trim().Length > 0)
                        {
                            ...
                            BindingKey(GetActivator.ActivateTextOverride.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.MiscItems.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetMiscItem.Name.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Books.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(Books.Name.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetDescription.Length > 0)
                        {
                            ...
                            BindingKey(Books.Description.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetBookText.Length > 0)
                        {
                            ...
                            BindingKey(Books.BookText.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.Messages.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetMessageItem.Name.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetDescription.Length > 0)
                        {
                            ...
                            BindingKey(GetMessageItem.Description.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                                ...
                                for (int ir = 0; ir < GetButtons.Count; ir++)
                                {
                                    try
                                    {
                                        ...
                                        if (GetButton.Length > 0)
                                        {
                                            ...
                                            BindingKey(GetButtons[ir].Text.StringsKey, GetUniqueKey);
                                        }
                                    }
                                    catch (Exception ex)
                                    {
                ...
                for (int i = 0; i < Reader.DialogTopics.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetDialogTopicItem.Name.StringsKey, GetUniqueKey);
                        }
                            ...
                            foreach (var GetChild in GetResponses)
                            {
                                try
                                {
                                    ...
                                    if (GetPrompt.Length > 0)
                                    {
                                        ...
                                        BindingKey(GetChild.Prompt.StringsKey, GetUniqueKey);
                                    }
                                        ...
                                        foreach (var GetChildA in GetChild.Responses)
                                        {
                                            try
                                            {
                                                ...
                                                if (GetValue.Length > 0)
                                                {
                                                    ...
                                                    BindingKey(GetChildA.Text.StringsKey, GetUniqueKey);
                                                }
                                            }
                                            catch (Exception ex)
                                            {
                ...
                for (int i = 0; i < Reader.Spells.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetSpellItem.Name.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetDescription.Length > 0)
                        {
                            ...
                            BindingKey(GetSpellItem.Description.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.ObjectEffects.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetObjectEffect.Name.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                for (int i = 0; i < Reader.MagicEffects.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetMagicEffect.Name.StringsKey, GetUniqueKey);
                        }
                        ...
                        if (GetDescription.Length > 0)
                        {
                            ...
                            BindingKey(GetMagicEffect.Description.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
                                        ...
                                        foreach (var GetChild in Get.Cells)
                                        {
                                            try
                                            {
                                                ...
                                                if (GetName.Length > 0)
                                                {
                                                    ...
                                                    BindingKey(GetChild.Name.StringsKey, GetUniqueKey);
                                                }
                                            }
                                            catch (Exception ex)
                                            {
                ...
                for (int i = 0; i < Reader.Locations.Count; i++)
                {
                    try
                    {
                        ...
                        if (GetName.Length > 0)
                        {
                            ...
                            BindingKey(GetLocationItem.Name.StringsKey, GetUniqueKey);
                        }
                    }
                    catch (Exception ex)
                    {
