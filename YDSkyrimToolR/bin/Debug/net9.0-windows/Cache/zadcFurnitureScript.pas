			...
			.state 
				.function CheckLockShield
					...
					.code
						...
						JumpF ::temp19 _label0                                   ;@line 184
						Return True                                              ;@line 185
						Jump _label0                                             ;@line 185
					_label0:
						...
						JumpF ::temp19 _label1                                   ;@line 189
						Return True                                              ;@line 190
						Jump _label2                                             ;@line 190
					_label1:
						...
						StrCat ::temp22 "787878788" ::temp22                     ;@line 193
				...
				.function CanMakeStruggleEscapeAttempt
					...
					.code
						...
						JumpF ::temp227 _label3                                  ;@line 1071
					...
					_label3:
						...
						JumpF ::temp230 _label5                                  ;@line 1076
					...
					_label5:
						JumpF ::temp230 _label6                                  ;@line 1076
				...
				.function CalculateCooldownModifier
					...
					_label9:
						...
						JumpF operator _label10                                  ;@line 978
				...
				.function DeviceMenuLockNPC
					...
					.code
						...
						JumpF ::temp100 _label12                                 ;@line 553
						...
						JumpF ::temp101 _label13                                 ;@line 556
					...
					_label13:
						JumpF ::temp101 _label14                                 ;@line 556
						...
						JumpF ::temp103 _label15                                 ;@line 558
						Assign ::isSelfBondage_var True                          ;@line 560
						JumpF ::AllowTimerDialogue_var _label16                  ;@line 561
				...
				.function StruggleScene
					...
					_label29:
						Cast ::temp198 ::temp198                                 ;@line 936
						JumpT ::temp198 _label30                                 ;@line 936
						CallMethod IsAnimating ::clib_var ::temp202 akActor      ;@line 936
						Cast ::temp198 ::temp202                                 ;@line 936
					_label30:
						JumpF ::temp198 _label31                                 ;@line 936
						Return None                                              ;@line 937
						Jump _label31                                            ;@line 937
					_label31:
						...
						JumpF ::temp202 _label32                                 ;@line 941
						Return None                                              ;@line 943
						Jump _label32                                            ;@line 943
					_label32:
				...
				.function CalclulateLockPickSuccess
					...
					.code
						...
						JumpF ::temp325 _label33                                 ;@line 1369
				...
				.function CanMakeUnlockAttempt
					...
					_label43:
						...
						StrCat ::temp78 "你仍然对上次尝试感到厌倦,并且已经无法再次尝试解锁该装置了!在 " ::temp78  ;@line 424
				...
				.function DeviceMenuLock
					...
					.endLocalTable
					.code
						JumpF ::CanBePickedUp_var _label45                       ;@line 459
					...
					_label46:
						...
						JumpF ::temp88 _label47                                  ;@line 464
					...
					_label48:
						...
						JumpF ::temp91 _label50                                  ;@line 469
						Assign ::isSelfBondage_var True                          ;@line 471
						JumpF ::AllowTimerDialogue_var _label51                  ;@line 472
					...
					_label49:
						...
						JumpF ::temp92 _label61                                  ;@line 498
						Assign ::isSelfBondage_var True                          ;@line 500
						JumpF ::AllowTimerDialogue_var _label62                  ;@line 501
					...
					_label69:
						...
						Jump _label71                                            ;@line 531
					_label71:
						Jump _label72                                            ;@line 531
					_label70:
						CompareEQ ::temp89 i 2                                   ;@line 534
						JumpF ::temp89 _label73                                  ;@line 534
				...
				.function SendDeviceEvent
					...
					.endLocalTable
					.code
						CallStatic modevent Create ::temp46 "DDC_DeviceEvent"    ;@line 247
						Assign Handle ::temp46                                   ;@line 247
						JumpF Handle _label78                                    ;@line 248
				...
				.function CalclulateStruggleSuccess
					...
					.code
						...
						JumpF ::temp282 _label79                                 ;@line 1203
				...
				.function DestroyLockPick
					...
					.code
						...
						JumpF ::temp321 _label96                                 ;@line 1350
					...
					_label96:
						JumpF ::temp321 _label97                                 ;@line 1350
					...
					_label100:
						...
						Jump _label101                                           ;@line 1360
					_label101:
						Jump _label102                                           ;@line 1360
					_label99:
				...
				.function CalculateDifficultyModifier
					...
					_label103:
						...
						JumpF operator _label104                                 ;@line 999
				...
				.function Escape
					...
					.code
						...
						JumpF ::temp256 _label106                                ;@line 1129
						Return False                                             ;@line 1131
						Jump _label106                                           ;@line 1131
					_label106:
						...
						JumpF ::temp256 _label107                                ;@line 1134
					...
					_label107:
						...
						JumpF ::temp264 _label108                                ;@line 1143
				...
				.function SexScene
					...
					.code
						...
						JumpT ::temp174 _label110                                ;@line 855
					...
					_label110:
						Cast ::temp174 ::temp174                                 ;@line 855
						JumpT ::temp174 _label111                                ;@line 855
						CallMethod GetIsFemale ::clib_var ::temp178 ::user_var   ;@line 855
						Not ::temp178 ::temp178                                  ;@line 855
						Cast ::temp174 ::temp178                                 ;@line 855
					_label111:
						JumpF ::temp174 _label112                                ;@line 855
						Return False                                             ;@line 856
						Jump _label112                                           ;@line 856
					_label112:
						...
						JumpF ::PartnerIsInFront_var _label113                   ;@line 861
					...
					_label114:
						...
						JumpF ::temp174 _label115                                ;@line 875
						Assign ani AnimationName                                 ;@line 876
						Jump _label116                                           ;@line 876
					_label115:
					...
					_label116:
						...
						JumpF ::temp178 _label117                                ;@line 880
				...
				.function ApplyEffects
					...
					_label122:
						...
						JumpF ::temp8 _label121                                  ;@line 160
				...
				.function LockActor
					...
					_label125:
						...
						JumpF ::temp55 _label127                                 ;@line 269
					...
					_label126:
						...
						JumpF ::ForceStripActor_var _label129                    ;@line 292
						CallMethod StripOutfit ::clib_var ::NoneVar ::user_var   ;@line 293
						Jump _label129                                           ;@line 293
					_label129:
					...
					_label136:
						...
						JumpF ::temp55 _label137                                 ;@line 318
						...
						CallStatic input GetMappedKey ::temp62 "Activate" 0      ;@line 322
						CallMethod RegisterForKey self ::NoneVar ::temp62        ;@line 322
						JumpF ::PreventWaitandSleep_var _label138                ;@line 323
					...
					_label137:
						...
						JumpF ::ForceTimer_var _label139                         ;@line 333
						Assign ::isSelfBondage_var True                          ;@line 334
						Jump _label139                                           ;@line 334
					_label139:
						...
						JumpF ::SendDeviceModEvents_var _label140                ;@line 351
						CallMethod SendDeviceEvent self ::NoneVar True           ;@line 352
						Jump _label140                                           ;@line 352
					_label140:
					.endCode
				.endFunction
				.function EscapeAttemptLockPick
					...
					.code
						...
						JumpF ::temp304 _label141                                ;@line 1300
				...
				.function ApplyDevices
					...
					_label176:
						...
						JumpF ::temp31 _label173                                 ;@line 222
						...
						JumpF ::temp34 _label174                                 ;@line 224
				...
				.function RemoveEffects
					...
					_label212:
						...
						JumpF ::temp12 _label211                                 ;@line 168
				...
				.function EscapeAttemptStruggle
					...
					_label215:
						...
						JumpF ::temp273 _label216                                ;@line 1183
				...
				.function UnlockAttemptNPC
					...
					.endLocalTable
					.code
						JumpF isLockManipulated _label220                        ;@line 632
						...
						Jump _label220                                           ;@line 635
					_label220:
						CallMethod CheckLockShield self ::temp117                ;@line 637
						Not ::temp117 ::temp117                                  ;@line 637
						JumpF ::temp117 _label221                                ;@line 637
						Return False                                             ;@line 638
						Jump _label221                                           ;@line 638
					_label221:
						JumpF ::deviceKey_var _label222                          ;@line 640
						...
						JumpF ::temp117 _label223                                ;@line 641
					...
					_label223:
						...
						JumpF ::temp121 _label224                                ;@line 644
						...
						Jump _label224                                           ;@line 646
					_label224:
						JumpF ::DestroyKey_var _label225                         ;@line 648
					...
					_label227:
						JumpF ::temp121 _label226                                ;@line 650
						...
						Jump _label226                                           ;@line 651
					_label226:
						Jump _label222                                           ;@line 651
					_label222:
				...
				.function UnlockActor
					...
					.endLocalTable
					.code
						JumpF ::user_var _label231                               ;@line 357
						...
						JumpF ::temp64 _label232                                 ;@line 364
				...
				.function CheckSelfBondageRelease
					...
					.code
						...
						JumpF ::temp23 _label239                                 ;@line 199
						Return None                                              ;@line 200
						Jump _label239                                           ;@line 200
					_label239:
						...
						JumpF ::temp23 _label240                                 ;@line 204
						PropGet PlayerRef ::libs_var ::temp25                    ;@line 205
						CompareEQ ::temp26 ::user_var ::temp25                   ;@line 205
						JumpF ::temp26 _label241                                 ;@line 205
						CallMethod notify ::libs_var ::NoneVar "565656" True     ;@line 206
						Jump _label241                                           ;@line 206
					_label241:
						CallMethod UnlockActor self ::NoneVar                    ;@line 208
						Return None                                              ;@line 209
						Jump _label242                                           ;@line 209
					_label240:
				...
				.function CanMakeBreakEscapeAttempt
					...
					.code
						...
						JumpF ::temp237 _label245                                ;@line 1091
					...
					_label245:
						...
						JumpF ::temp240 _label247                                ;@line 1096
					...
					_label247:
						JumpF ::temp240 _label248                                ;@line 1096
				...
				.function PickRandomSexScene
					...
					.code
						...
						JumpF ::temp5 _label251                                  ;@line 152
						Return ""                                                ;@line 153
						Jump _label251                                           ;@line 153
					_label251:
				...
				.function OnUpdate
					...
					.code
						...
						JumpF ::temp151 _label255                                ;@line 784
						Assign StruggleTick 0                                    ;@line 785
						Jump _label255                                           ;@line 785
					_label255:
				...
				.function EscapeAttemptBreak
					...
					.code
						...
						JumpF ::temp289 _label259                                ;@line 1240
						Return None                                              ;@line 1241
						Jump _label259                                           ;@line 1241
					_label259:
						...
						JumpF ::temp289 _label260                                ;@line 1244
				...
				.function UnlockAttempt
					...
					.endLocalTable
					.code
						JumpF isLockManipulated _label264                        ;@line 660
						...
						Jump _label264                                           ;@line 663
					_label264:
						CallMethod CheckLockShield self ::temp125                ;@line 665
						Not ::temp125 ::temp125                                  ;@line 665
						JumpF ::temp125 _label265                                ;@line 665
						Return False                                             ;@line 666
						Jump _label265                                           ;@line 666
					_label265:
						JumpF ::deviceKey_var _label266                          ;@line 668
						...
						JumpF ::temp125 _label267                                ;@line 669
					...
					_label267:
						...
						JumpF ::temp129 _label268                                ;@line 672
					...
					_label272:
						JumpF ::temp129 _label271                                ;@line 683
						...
						Jump _label271                                           ;@line 684
					_label271:
						Jump _label273                                           ;@line 684
					_label266:
						CallMethod CheckLockAccess self ::temp125                ;@line 687
						Not ::temp129 ::temp125                                  ;@line 687
						JumpF ::temp129 _label273                                ;@line 687
						Return False                                             ;@line 688
						Jump _label273                                           ;@line 688
					_label273:
				...
				.function CalclulateBreakSuccess
					...
					.code
						...
						JumpF ::temp296 _label274                                ;@line 1264
						...
						JumpT ::temp300 _label275                                ;@line 1267
						PropGet PlayerRef ::libs_var ::temp298                   ;@line 1267
					...
					_label276:
						...
						JumpT ::temp301 _label277                                ;@line 1270
						PropGet PlayerRef ::libs_var ::temp298                   ;@line 1270
					...
					_label278:
						...
						JumpT ::temp300 _label279                                ;@line 1273
						PropGet PlayerRef ::libs_var ::temp298                   ;@line 1273
				...
				.function HasValidLockPick
					...
					.code
						...
						JumpF ::temp315 _label287                                ;@line 1334
					...
					_label287:
						JumpF ::temp315 _label288                                ;@line 1334
						Return True                                              ;@line 1335
						Jump _label288                                           ;@line 1335
					_label288:
					...
					_label292:
						...
						JumpF ::temp315 _label289                                ;@line 1338
						Not ::temp316 HasValidItem                               ;@line 1338
						Cast ::temp315 ::temp316                                 ;@line 1338
					_label289:
						JumpF ::temp315 _label290                                ;@line 1338
						...
						JumpF ::temp316 _label291                                ;@line 1341
						Assign HasValidItem True                                 ;@line 1342
						Jump _label291                                           ;@line 1342
					_label291:
						Jump _label292                                           ;@line 1342
					_label290:
				...
				.function OnSexEnd
					...
					_label296:
						...
						JumpF ::temp158 _label297                                ;@line 819
				...
				.function PasserbyAction
					...
					_label300:
						Cast ::temp137 ::temp137                                 ;@line 754
						JumpT ::temp137 _label301                                ;@line 754
						CallMethod IsAnimating ::clib_var ::temp138 ::user_var   ;@line 754
						Cast ::temp137 ::temp138                                 ;@line 754
					_label301:
						JumpF ::temp137 _label302                                ;@line 754
						Return False                                             ;@line 755
						Jump _label302                                           ;@line 755
					_label302:
					...
					_label306:
						...
						JumpF ::temp138 _label307                                ;@line 769
				...
				.function CanMakeLockPickEscapeAttempt
					...
					.code
						...
						JumpF ::temp247 _label311                                ;@line 1111
					...
					_label311:
						...
						JumpF ::temp250 _label313                                ;@line 1116
					...
					_label313:
						JumpF ::temp250 _label314                                ;@line 1116
				...
				.function RemoveDevices
					...
					_label320:
						...
						JumpF ::temp39 _label317                                 ;@line 234
						...
						JumpF ::temp42 _label318                                 ;@line 236
				...
				.function OnKeyDown
					...
					.code
						...
						JumpF ::temp71 _label321                                 ;@line 410
