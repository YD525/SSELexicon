			...
			.state 
				...
				.function ecSlider
					...
					_label6:
						...
						Jump _label8                                             ;@line 141
					_label8:
						Not ::temp25 ::ecBurnIn_var                              ;@line 143
						JumpF ::temp25 _label9                                   ;@line 143
				...
				.function OnSliderOpenST
					...
					.code
						...
						JumpF ::temp56 _label10                                  ;@line 234
						Return None                                              ;@line 235
						Jump _label10                                            ;@line 235
					_label10:
						...
						JumpF ::temp56 _label11                                  ;@line 238
				...
				.function ecCheck
					...
					.code
						...
						JumpF ::temp105 _label12                                 ;@line 410
					...
					_label12:
						...
						JumpF ::temp104 _label13                                 ;@line 411
				...
				.function ecToggle
					...
					.code
						...
						JumpT ::temp17 _label14                                  ;@line 105
						Cast ::temp17 ::ecUpdate_var                             ;@line 105
					_label14:
						Cast ::temp17 ::temp17                                   ;@line 105
						JumpT ::temp17 _label15                                  ;@line 105
					...
					_label16:
						...
						Jump _label18                                            ;@line 115
					_label18:
						Not ::temp17 ::ecBurnIn_var                              ;@line 117
						JumpF ::temp17 _label19                                  ;@line 117
				...
				.function ecExport
					...
					.code
						...
						CallMethod ecTextUpdate self ::NoneVar "WEQ1"            ;@line 297
					...
					_label24:
						...
						JumpF ::temp76 _label20                                  ;@line 300
						...
						JumpF ::temp78 _label21                                  ;@line 304
						...
						Jump _label22                                            ;@line 305
					_label21:
						CompareEQ ::temp79 type ecTypeSlider                     ;@line 306
						JumpF ::temp79 _label23                                  ;@line 306
						...
						Jump _label22                                            ;@line 307
					_label23:
						CompareEQ ::temp79 type ecTypeText                       ;@line 308
						JumpF ::temp79 _label22                                  ;@line 308
						...
						Jump _label22                                            ;@line 309
					_label22:
						Jump _label24                                            ;@line 309
					_label20:
				...
				.function ecStartup
					...
					.code
						...
						JumpF ::temp3 _label28                                   ;@line 30
						JumpF ::ecBurnIn_var _label29                            ;@line 32
					_label31:
						JumpF ::ecBurnIn_var _label30                            ;@line 33
						CallStatic utility Wait ::NoneVar 3.000000               ;@line 34
						Jump _label31                                            ;@line 34
					_label30:
						Return None                                              ;@line 36
						Jump _label32                                            ;@line 36
					_label29:
				...
				.function ecDump
					...
					_label44:
						...
						JumpF ::temp94 _label40                                  ;@line 375
						...
						JumpF ::temp96 _label41                                  ;@line 379
						...
						Jump _label42                                            ;@line 380
					_label41:
						CompareEQ ::temp99 type ecTypeSlider                     ;@line 381
						JumpF ::temp99 _label43                                  ;@line 381
						...
						Jump _label42                                            ;@line 382
					_label43:
						CompareEQ ::temp99 type ecTypeText                       ;@line 383
						JumpF ::temp99 _label42                                  ;@line 383
						...
						Jump _label42                                            ;@line 384
					_label42:
						Jump _label44                                            ;@line 384
					_label40:
				...
				.function OnHighlightST
					...
					.code
						...
						JumpF storeKey _label45                                  ;@line 193
				...
				.function ecImport
					...
					.code
						...
						JumpF ::temp81 _label50                                  ;@line 324
						CallMethod ecTextUpdate self ::NoneVar "WEQ2"            ;@line 325
					...
					_label62:
						...
						JumpF ::temp85 _label51                                  ;@line 329
					...
					_label51:
						...
						JumpF ::temp87 _label63                                  ;@line 359
				...
				.function OnSliderAcceptST
					...
					.code
						...
						JumpF ::temp65 _label65                                  ;@line 266
						Return None                                              ;@line 267
						Jump _label65                                            ;@line 267
					_label65:
						...
						JumpF ::temp65 _label66                                  ;@line 270
				...
				.function OnSelectST
					...
					.code
						...
						JumpF ::temp51 _label67                                  ;@line 218
						Return None                                              ;@line 219
						Jump _label67                                            ;@line 219
					_label67:
						...
						JumpF ::temp51 _label68                                  ;@line 222
				...
				.function OnDefaultST
					...
					.code
						...
						JumpF ::temp45 _label73                                  ;@line 199
						Return None                                              ;@line 200
						Jump _label73                                            ;@line 200
					_label73:
						...
						JumpF ::temp45 _label74                                  ;@line 203
						...
						Jump _label75                                            ;@line 207
					_label74:
						CompareEQ ::temp48 type ecTypeSlider                     ;@line 208
						JumpF ::temp48 _label75                                  ;@line 208
				...
				.function ecText
					...
					.code
						...
						JumpT ::temp28 _label76                                  ;@line 150
						Cast ::temp28 ::ecUpdate_var                             ;@line 150
					_label76:
						Cast ::temp28 ::temp28                                   ;@line 150
						JumpT ::temp28 _label77                                  ;@line 150
					...
					_label78:
						...
						Jump _label80                                            ;@line 160
					_label80:
						Not ::temp31 ::ecBurnIn_var                              ;@line 162
						JumpF ::temp31 _label81                                  ;@line 162
