			...
			.state 
				.function ecExport
					...
					_label4:
						...
						Jump _label2                                             ;@line 305
					_label1:
						CompareEQ ::temp79 type ecTypeSlider                     ;@line 306
						JumpF ::temp79 _label3                                   ;@line 306
						...
						Jump _label2                                             ;@line 307
					_label3:
						CompareEQ ::temp79 type ecTypeText                       ;@line 308
						JumpF ::temp79 _label2                                   ;@line 308
						...
						Jump _label2                                             ;@line 309
					_label2:
						Jump _label4                                             ;@line 309
					_label0:
				...
				.function ecStartup
					...
					.code
						...
						JumpF ::temp3 _label5                                    ;@line 30
						JumpF ::ecBurnIn_var _label6                             ;@line 32
					_label8:
						JumpF ::ecBurnIn_var _label7                             ;@line 33
						CallStatic utility Wait ::NoneVar 3.000000               ;@line 34
						Jump _label8                                             ;@line 34
					_label7:
						Return None                                              ;@line 36
						Jump _label9                                             ;@line 36
					_label6:
				...
				.function ecImport
					...
					.code
						...
						JumpF ::temp81 _label19                                  ;@line 324
					...
					_label31:
						...
						JumpF ::temp85 _label20                                  ;@line 329
					...
					_label25:
						...
						Jump _label29                                            ;@line 347
					_label28:
						Assign type -1                                           ;@line 349
					_label29:
						Jump _label24                                            ;@line 349
					_label24:
						CompareEQ ::temp88 type -1                               ;@line 352
						JumpF ::temp88 _label30                                  ;@line 352
						...
						Jump _label30                                            ;@line 354
					_label30:
						Jump _label31                                            ;@line 354
					_label20:
						...
						JumpF ::temp87 _label32                                  ;@line 359
				...
				.function OnSliderOpenST
					...
					.code
						...
						JumpF ::temp56 _label34                                  ;@line 234
						Return None                                              ;@line 235
						Jump _label34                                            ;@line 235
					_label34:
						...
						JumpF ::temp56 _label35                                  ;@line 238
				...
				.function OnDefaultST
					...
					.code
						...
						JumpF ::temp45 _label37                                  ;@line 199
						Return None                                              ;@line 200
						Jump _label37                                            ;@line 200
					_label37:
						...
						JumpF ::temp45 _label38                                  ;@line 203
						...
						Jump _label39                                            ;@line 207
					_label38:
						CompareEQ ::temp48 type ecTypeSlider                     ;@line 208
						JumpF ::temp48 _label39                                  ;@line 208
				...
				.function OnHighlightST
					...
					.code
						...
						JumpF storeKey _label40                                  ;@line 193
				...
				.function OnSelectST
					...
					.code
						...
						JumpF ::temp51 _label41                                  ;@line 218
						Return None                                              ;@line 219
						Jump _label41                                            ;@line 219
					_label41:
						...
						JumpF ::temp51 _label42                                  ;@line 222
				...
				.function ecToggle
					...
					.code
						...
						JumpT ::temp17 _label50                                  ;@line 105
						Cast ::temp17 ::ecUpdate_var                             ;@line 105
					_label50:
						Cast ::temp17 ::temp17                                   ;@line 105
						JumpT ::temp17 _label51                                  ;@line 105
					...
					_label52:
						...
						Jump _label54                                            ;@line 115
					_label54:
						Not ::temp17 ::ecBurnIn_var                              ;@line 117
						JumpF ::temp17 _label55                                  ;@line 117
				...
				.function ecSlider
					...
					_label59:
						...
						Jump _label61                                            ;@line 141
					_label61:
						Not ::temp25 ::ecBurnIn_var                              ;@line 143
						JumpF ::temp25 _label62                                  ;@line 143
				...
				.function ecText
					...
					.code
						...
						JumpT ::temp28 _label65                                  ;@line 150
						Cast ::temp28 ::ecUpdate_var                             ;@line 150
					_label65:
						Cast ::temp28 ::temp28                                   ;@line 150
						JumpT ::temp28 _label66                                  ;@line 150
					...
					_label67:
						...
						Jump _label69                                            ;@line 160
					_label69:
						Not ::temp31 ::ecBurnIn_var                              ;@line 162
						JumpF ::temp31 _label70                                  ;@line 162
				...
				.function ecCheck
					...
					.code
						...
						JumpF ::temp105 _label74                                 ;@line 410
					...
					_label74:
						...
						JumpF ::temp104 _label75                                 ;@line 411
				...
				.function ecKey
					...
					_label76:
						...
						JumpF ::temp39 _label77                                  ;@line 184
				...
				.function OnSliderAcceptST
					...
					.code
						...
						JumpF ::temp65 _label79                                  ;@line 266
						Return None                                              ;@line 267
						Jump _label79                                            ;@line 267
					_label79:
						...
						JumpF ::temp65 _label80                                  ;@line 270
				...
				.function ecDump
					...
					_label85:
						...
						JumpF ::temp94 _label81                                  ;@line 375
						...
						JumpF ::temp96 _label82                                  ;@line 379
						...
						Jump _label83                                            ;@line 380
					_label82:
						CompareEQ ::temp99 type ecTypeSlider                     ;@line 381
						JumpF ::temp99 _label84                                  ;@line 381
						...
						Jump _label83                                            ;@line 382
					_label84:
						CompareEQ ::temp99 type ecTypeText                       ;@line 383
						JumpF ::temp99 _label83                                  ;@line 383
						...
						Jump _label83                                            ;@line 384
					_label83:
						Jump _label85                                            ;@line 384
					_label81:
