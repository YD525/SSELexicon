			...
			.state 
				.function OnSliderOpenST
					...
					.code
						...
						JumpF ::temp56 _label0                                   ;@line 234
						Return None                                              ;@line 235
						Jump _label0                                             ;@line 235
					_label0:
				...
				.function OnDefaultST
					...
					.code
						...
						JumpF ::temp45 _label4                                   ;@line 199
						Return None                                              ;@line 200
						Jump _label4                                             ;@line 200
					_label4:
						...
						Jump _label6                                             ;@line 207
					_label5:
						CompareEQ ::temp48 type ecTypeSlider                     ;@line 208
						JumpF ::temp48 _label6                                   ;@line 208
						...
						CallMethod SetSliderOptionValueST self ::NoneVar ::mangled_default_0 "{0}" False ""  ;@line 211
						CallMethod ecConfigChanged self ::NoneVar                ;@line 212
						Jump _label6                                             ;@line 212
					_label6:
					.endCode
				.endFunction
				.function ecStartup
					...
					.code
						...
						JumpF ::temp3 _label7                                    ;@line 30
						JumpF ::ecBurnIn_var _label8                             ;@line 32
					_label10:
						JumpF ::ecBurnIn_var _label9                             ;@line 33
						CallStatic utility Wait ::NoneVar 3.000000               ;@line 34
						Jump _label10                                            ;@line 34
					_label9:
						Return None                                              ;@line 36
						Jump _label11                                            ;@line 36
					_label8:
				...
				.function OnSelectST
					...
					.code
						...
						JumpF ::temp51 _label14                                  ;@line 218
						Return None                                              ;@line 219
						Jump _label14                                            ;@line 219
					_label14:
						...
						JumpF ::temp51 _label15                                  ;@line 222
				...
				.function ecCheck
					...
					.code
						...
						JumpF ::temp105 _label16                                 ;@line 410
					...
					_label16:
						...
						JumpF ::temp104 _label17                                 ;@line 411
				...
				.function ecSlider
					...
					_label29:
						...
						Jump _label31                                            ;@line 141
					_label31:
						Not ::temp25 ::ecBurnIn_var                              ;@line 143
						JumpF ::temp25 _label32                                  ;@line 143
				...
				.function ecImport
					...
					.code
						...
						JumpF ::temp81 _label33                                  ;@line 324
						CallMethod ecTextUpdate self ::NoneVar "驱蚊器"       ;@line 325
					...
					_label45:
						...
						JumpF ::temp85 _label34                                  ;@line 329
					...
					_label34:
						...
						JumpF ::temp87 _label46                                  ;@line 359
						Cast ::temp86 missing                                    ;@line 360
						StrCat ::temp86 "恶气呃" ::temp86                     ;@line 360
				...
				.function OnSliderAcceptST
					...
					.code
						...
						JumpF ::temp65 _label48                                  ;@line 266
						Return None                                              ;@line 267
						Jump _label48                                            ;@line 267
					_label48:
						...
						JumpF ::temp65 _label49                                  ;@line 270
				...
				.function ecDump
					...
					_label54:
						...
						JumpF ::temp94 _label50                                  ;@line 375
						...
						JumpF ::temp96 _label51                                  ;@line 379
						...
						Jump _label52                                            ;@line 380
					_label51:
						CompareEQ ::temp99 type ecTypeSlider                     ;@line 381
						JumpF ::temp99 _label53                                  ;@line 381
						...
						Jump _label52                                            ;@line 382
					_label53:
						CompareEQ ::temp99 type ecTypeText                       ;@line 383
						JumpF ::temp99 _label52                                  ;@line 383
						...
						Jump _label52                                            ;@line 384
					_label52:
						Jump _label54                                            ;@line 384
					_label50:
				...
				.function ecKey
					...
					_label56:
						...
						JumpF ::temp39 _label57                                  ;@line 184
				...
				.function ecToggle
					...
					.code
						...
						JumpT ::temp17 _label62                                  ;@line 105
						Cast ::temp17 ::ecUpdate_var                             ;@line 105
					_label62:
						Cast ::temp17 ::temp17                                   ;@line 105
						JumpT ::temp17 _label63                                  ;@line 105
					...
					_label64:
						...
						Jump _label66                                            ;@line 115
					_label66:
						Not ::temp17 ::ecBurnIn_var                              ;@line 117
						JumpF ::temp17 _label67                                  ;@line 117
				...
				.function ecExport
					...
					.code
						...
						CallMethod ecTextUpdate self ::NoneVar "1委屈恶气"   ;@line 297
					...
					_label72:
						...
						JumpF ::temp76 _label68                                  ;@line 300
						...
						JumpF ::temp78 _label69                                  ;@line 304
						...
						Jump _label70                                            ;@line 305
					_label69:
						CompareEQ ::temp79 type ecTypeSlider                     ;@line 306
						JumpF ::temp79 _label71                                  ;@line 306
						...
						Jump _label70                                            ;@line 307
					_label71:
						CompareEQ ::temp79 type ecTypeText                       ;@line 308
						JumpF ::temp79 _label70                                  ;@line 308
						...
						Jump _label70                                            ;@line 309
					_label70:
						Jump _label72                                            ;@line 309
					_label68:
				...
				.function OnHighlightST
					...
					.code
						...
						JumpF storeKey _label77                                  ;@line 193
				...
				.function ecText
					...
					.code
						...
						JumpT ::temp28 _label80                                  ;@line 150
						Cast ::temp28 ::ecUpdate_var                             ;@line 150
					_label80:
						Cast ::temp28 ::temp28                                   ;@line 150
						JumpT ::temp28 _label81                                  ;@line 150
					...
					_label82:
						...
						Jump _label84                                            ;@line 160
					_label84:
						Not ::temp31 ::ecBurnIn_var                              ;@line 162
						JumpF ::temp31 _label85                                  ;@line 162
